      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex-1">
          <Input
            ...
            className="font-heading border-transparent bg-transparent text-2xl font-bold focus:border-input focus:bg-background"
            disabled={saving}
          />
        </div>
      ...
      {aiDescription && (
        <div className="bg-muted/50 rounded-lg border p-4">
          <div className="mb-1 flex items-center gap-2">
            ...
            <span className="text-xs font-medium">AI-generated description</span>
          </div>
